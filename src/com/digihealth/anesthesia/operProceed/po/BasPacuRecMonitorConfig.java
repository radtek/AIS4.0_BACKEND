...
@ApiModel(value="复苏监测标记点设置对象")
public class BasPacuRecMonitorConfig {
    /**
     * 主键id
     */
    ...
    public Integer getWidthAndHeight() {
		return widthAndHeight;
	}

	public void setWidthAndHeight(Integer widthAndHeight) {
		this.widthAndHeight = widthAndHeight==null ?null:widthAndHeight ;
	}
