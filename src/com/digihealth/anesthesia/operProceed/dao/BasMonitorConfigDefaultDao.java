...
public interface BasMonitorConfigDefaultDao {
    ...
    BasMonitorConfigDefault selectByEventName(@Param("eventName") String eventName, @Param("beid") String beid, @Param("docType") Integer docType);
    
    List<BasMonitorConfigDefault> selectAll(@Param("beid") String beid, @Param("docType") Integer docType);
}