...
public class MonitorPupilFormBean {
    ...
    private String electDiogData;
    
    

	public String getElectDiogData() {
		return electDiogData;
	}

	public void setElectDiogData(String electDiogData) {
		this.electDiogData = electDiogData;
	}
