...
public class BasObserveService extends BaseService {
	...
	public List<Observe> searchAnaesObserveList(String beid, String operId) {
		...
		return basMonitorConfigDao.searchAnaesObserveList(beid, operId ,getCurRoomId(operId));
	}
	
	public BasMonitorConfig searchMonitorConfig (String eventId,String beid,String regOptId){
		if(StringUtils.isBlank(beid)){
			beid = getBeid();
		}
