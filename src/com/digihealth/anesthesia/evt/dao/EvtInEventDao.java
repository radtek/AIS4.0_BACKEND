...
public interface EvtInEventDao {
	...
	public Integer getIoeventCountValueByIoDef(@Param("docId")String docId, @Param("ioDefId")String ioDefId, @Param("subType")String subType,@Param("docType")Integer docType);
	
	public String seleteIoeventSumByDocId(@Param("docId")String docId, @Param("beid")String beid,@Param("docType")Integer docType);
	
	public String seleteEgressSumByDocId(@Param("docId")String docId, @Param("docType")Integer docType);
	
	//public int deleteByDocId(@Param("docId")String docId);
	
	public String seleteEmictionSumByDocId(@Param("docId")String docId, @Param("docType")Integer docType);
	
	public String seleteBloodSumByDocId(@Param("docId")String docId, @Param("docType")Integer docType);
	
	public String seleteOtherSumByDocId(@Param("docId")String docId, @Param("docType")Integer docType);
	...
	public Integer getIoeventCountValueByName(@Param("docId")String docId,@Param("name")String name,@Param("docType")Integer docType);
}