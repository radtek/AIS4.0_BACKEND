...
public interface EvtAnaesEventDao extends CrudDao<EvtAnaesEvent>{
    ...
    public List<EvtAnaesEvent> selectCodeByDESC(@Param("docId")String docId,@Param("code")int code, @Param("docType")Integer docType);
    
    public List<EvtAnaesEvent> selectCodeByASC(@Param("docId")String docId,@Param("code")int code, @Param("docType")Integer docType);
