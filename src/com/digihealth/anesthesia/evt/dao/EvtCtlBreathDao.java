...
public interface EvtCtlBreathDao {
	 ...
	 * @return
	 */
	public List<EvtCtlBreath> searchBreathListOrder(@Param("regOptId")String regOptId, @Param("docType")Integer docType);
	
	public EvtCtlBreath queryCurCtlBreath(@Param("docId")String docId, @Param("docType")Integer docType);
}