...
public interface EvtEgressDao {
    ...
    public Integer getEgressCountValueByIoDefName(@Param("name")String name,@Param("docId")String docId,@Param("docType")Integer docType);
    
    public Integer getEgressCountValueByIoDef(@Param("ioDefId")String ioDefId,@Param("docId")String docId,@Param("docType")Integer docType);
