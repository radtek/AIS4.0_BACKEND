...
public class EvtMedicalEvent {
	...
	private List<String> medTakeWayIdList;
	/**
	...
	public List<String> getMedTakeWayIdList() {
		return medTakeWayIdList;
	}

	public void setMedTakeWayIdList(List<String> medTakeWayIdList) {
		this.medTakeWayIdList = medTakeWayIdList;
	}
