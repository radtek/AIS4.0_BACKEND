...
public class EvtParticipantController extends BaseController {
	...
	@RequestMapping(value = "/saveParticipantHNHTYY")
	@ResponseBody
	@ApiOperation(value = "保存手术人员信息", httpMethod = "POST", notes = "保存手术人员信息")
	public String saveParticipantHNHTYY(@ApiParam(name = "participantList", value = "参数")@RequestBody List<EvtParticipant> participantList) {
		logger.info("begin saveParticipantHNHTYY");
		ResponseValue resp = new ResponseValue();
		evtParticipantService.saveParticipantHNHTYY(participantList);
		logger.info("end saveParticipantHNHTYY");
		return resp.getJsonStr();
	}
}
