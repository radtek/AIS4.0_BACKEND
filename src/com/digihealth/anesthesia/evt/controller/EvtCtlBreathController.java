...
public class EvtCtlBreathController extends BaseController {
	...
	@RequestMapping(value = "/deleteCtlBreath")
    @ResponseBody
    @ApiOperation(value = "删除呼吸事件", httpMethod = "POST", notes = "删除呼吸事件")
    public String deleteCtlBreath(@ApiParam(name = "ctlBreath", value = "参数")@RequestBody EvtCtlBreath ctlBreath){
        logger.info("begin deleteCtlBreath");
        ResponseValue resp = new ResponseValue();
        evtCtlBreathService.deleteCtlBreath(ctlBreath);
        logger.info("end deleteCtlBreath");
        return resp.getJsonStr();
    }
}
