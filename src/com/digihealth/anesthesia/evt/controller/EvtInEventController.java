...
public class EvtInEventController extends BaseController {
	...
	public String totleIoEvent(@ApiParam(name = "ioevent", value = "参数")@RequestBody SearchFormBean searchBean) {
		...
		String blood = evtInEventService.seleteBloodSumByDocId(searchBean.getDocId(), docType);
		String egress = evtInEventService.seleteEgressSumByDocId(searchBean.getDocId(), docType);
		String emiction = evtInEventService.seleteEmictionSumByDocId(searchBean.getDocId(), docType);
		String ioevent = evtInEventService.seleteIoeventSumByDocId(searchBean.getDocId(), docType);
		String otherEgress = evtInEventService.seleteOtherSumByDocId(searchBean.getDocId(), docType);
