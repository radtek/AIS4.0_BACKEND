			...
			for (int i = 0; i < filters.size(); i++) {
				if(filters.get(i).getField().toString().equals("pinYin")){
					...
					if(filters.get(i).getField().toString().equals("professionalTitle")){
						list = basDictItemDao.searchSysCodeByGroupIdAndCodeName("professionalTitle", filters.get(i).getValue().toString(), beid);
					}
					if(filters.get(i).getField().toString().equals("administrativeLeve")){
						list = basDictItemDao.searchSysCodeByGroupIdAndCodeName("executiveLevel", filters.get(i).getValue().toString(), beid);
					}
		...
		if (filters != null && filters.size() > 0) {
			for (int i = 0; i < filters.size(); i++) {
				if(filters.get(i).getField().toString().equals("pinYin")){
					...
					//List<SysCodeFormbean> list = basDictItemDao.searchSysCodeByGroupId(StringUtils.zhuanData(filters.get(i).getValue().toString()));
					List<SysCodeFormbean> list = null;
					if(filters.get(i).getField().toString().equals("professionalTitle")){
						list = basDictItemDao.searchSysCodeByGroupIdAndCodeName("professional_title", filters.get(i).getValue().toString(), beid);
					}
					if(filters.get(i).getField().toString().equals("administrativeLeve")){
						list = basDictItemDao.searchSysCodeByGroupIdAndCodeName("executive_level", filters.get(i).getValue().toString(), beid);
					}
		...
		if (filters != null && filters.size() > 0) {
			for (int i = 0; i < filters.size(); i++) {
				if(filters.get(i).getField().toString().equals("pinYin")){
					...
					List<SysCodeFormbean> list = null;
					if(filters.get(i).getField().toString().equals("professionalTitle")){
						list = basDictItemDao.searchSysCodeByGroupIdAndCodeName("professional_title", filters.get(i).getValue().toString(), getBeid());
					}
					if(filters.get(i).getField().toString().equals("executiveLevel")){
						list = basDictItemDao.searchSysCodeByGroupIdAndCodeName("executive_level", filters.get(i).getValue().toString(), getBeid());
					}
