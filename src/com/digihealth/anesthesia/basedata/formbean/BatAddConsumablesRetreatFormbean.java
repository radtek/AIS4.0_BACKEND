 ...
 *
 */
public class BatAddConsumablesRetreatFormbean {
	/**
     * 退药日期
     */
    ...
    private List<BasConsumablesRetreatRecord> resList;
	...
	public List<BasConsumablesRetreatRecord> getResList() {
		return resList;
	}

	public void setResList(List<BasConsumablesRetreatRecord> resList) {
