...
public interface BasDeviceSpecificationDao {
    ...
    public List<BasDeviceSpecificationFormBean> queryBasDeviceListByBeid(@Param("filter")String filter,@Param("systemSearchFormBean")SystemSearchFormBean systemSearchFormBean);
