...
public interface BasDispatchDao extends CrudDao<BasDispatch>{
    ...
    String getCurRoomIdByRegOptId(@Param("regOptId")String regOptId);
    
    public String autoGetPcs(@Param("operRoomId")String operRoomId, @Param("operRegDate")String operRegDate, @Param("beid")String beid);
    
    public List<BasDispatch> getBasDispatchListByAnaesDoc(@Param("operRoomId")String operRoomId, @Param("operRegDate")String operRegDate, @Param("anesthetistId")String anesthetistId, @Param("beid")String beid);
}