...
public interface BasMedicineDao {
    ...
    public List<MedicineFormBean> findList(@Param("filter")String filter, @Param("baseQuery") BaseInfoQuery baseQuery);
    ...
    public List<MedicineFormBean> queryCommonUseList(@Param("baseQuery") BaseInfoQuery baseQuery);
}