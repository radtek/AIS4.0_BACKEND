...
public interface BasDeptDao extends CrudDao<BasDept> {
	...
	public BasDept searchDeptById(@Param("deptId")String deptId,@Param("beid")String beid);
	...
	public List<BasDept> selectByCode(@Param("code")String code,@Param("beid")String beid);
