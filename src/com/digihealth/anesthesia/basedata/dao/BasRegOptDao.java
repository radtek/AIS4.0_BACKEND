...
public interface BasRegOptDao extends CrudDao<BasRegOpt>{
	 ...
	 * @return
	 */
	public List<SearchRegOptByRoomIdAndOperDateAndStateFormBean> searchDayRegOpt(@Param("roomId")String roomId,@Param("operDate")String operDate, @Param("beid") String beid,@Param("filters") List<Filter> filters,@Param("searchFormBean") SystemSearchFormBean searchFormBean);
	...
	public int queryPayStatusByRegOptId(@Param("costType")String costType,@Param("regOptId")String regOptId);
	
	public int updatePayState(BasRegOpt regOpt);
	
	public BasRegOpt searchByPatientIdAndVisitId(@Param("patientId")String patientId, @Param("visitId")String visitId, @Param("beid")String beid);
	
	public List<CentralBigScreenDataFormbean> queryCentralBigScreenData(@Param("showFreeBed")String showFreeBed,@Param("beid")String beid);
    ...
    public List<SearchRegOptByLoginNameAndStateFormBean> getCurrentDateRegOpt(SearchConditionFormBean searchConditionFormBean);
    
    public int getCurrentDateRegOptTotal(SearchConditionFormBean searchConditionFormBean);
    
    public List<BasRegOpt> getRegOptListByOperTime(@Param("operaDate")String operaDate);
    
    public List<SearchRegOptByLoginNameAndStateFormBean> searchRegOptByRoleTypeAndState(@Param("filter") String filter,
        @Param("roleType") String roleType, @Param("searchConditionFormBean") SearchConditionFormBean searchConditionFormBean, @Param("beid") String beid);

    public int searchRegoptTotalByRoleTypeAndState(@Param("filter") String filter,
        @Param("roleType") String roleType, @Param("searchConditionFormBean") SearchConditionFormBean searchConditionFormBean, @Param("beid") String beid);
    
    public List<BasRegOpt> searchRegOptByOperaDate(@Param("operaDate")String operaDate,@Param("beid") String beid);
}