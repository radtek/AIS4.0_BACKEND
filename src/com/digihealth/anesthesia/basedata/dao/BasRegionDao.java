...
public interface BasRegionDao extends EntityDao<String, BasRegion>{
    ...
    public BasRegion searchRegionById(@Param("regionId")String regionId,@Param("beid") String beid);
    ...
    public List<BasRegion> selectByCode(@Param("code")String code,@Param("beid") String beid);
