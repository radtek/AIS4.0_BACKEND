...
public interface BasOperroomDao extends CrudDao<BasOperroom>{
    int deleteByPrimaryKey(@Param("operRoomId")String operRoomId, @Param("beid")String beid);
	...
	public int updateHealthnurse(@Param("operRoomId")String operRoomId,@Param("healthnurse")String healthnurse, @Param("beid")String beid);
	...
	String getMaxOperroomIdByBeid(@Param("beid")String beid);
	
	public List<BasOperroom> queryRoomListByIpPort(@Param("remotehost")String remotehost,@Param("remoteport")int remoteport);
