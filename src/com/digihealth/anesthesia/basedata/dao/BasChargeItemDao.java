...
public interface BasChargeItemDao extends CrudDao<BasChargeItem> {
    ...
    int updateByPrimaryKeySelective(BasChargeItem record);
    ...
    public List<BasChargeItem> selectByCodeAndName(@Param("code")String code,@Param("name")String name,@Param("beid")String beid);
    
    public int deleteChargeItemByBeid(@Param("beid")String beid);
}