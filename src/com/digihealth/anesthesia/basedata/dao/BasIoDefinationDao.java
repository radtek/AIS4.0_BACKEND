...
public interface BasIoDefinationDao {
    ...
    public List<IoDefinationFormBean> queryCommonUseInList(@Param("baseQuery") BaseInfoQuery baseQuery);
    public List<IoDefinationFormBean> queryCommonUseEgressList(@Param("baseQuery") BaseInfoQuery baseQuery);
}