...
public class BasConsumablesOutRecord {
    /**
     * id
     */
    private Integer id;
     ...
     * 退药数量(显示用)
     */
    private Integer showRetreatNumber = 0;
    ...
    public Integer getShowRetreatNumber() {
		return showRetreatNumber;
	}
     ...
     * @param retreatNumber
     */
	public void setShowRetreatNumber(Integer showRetreatNumber) {
		this.showRetreatNumber = showRetreatNumber;
	}
