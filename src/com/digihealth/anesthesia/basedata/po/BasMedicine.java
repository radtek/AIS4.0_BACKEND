...
public class BasMedicine {
     ...
     * 常用药品
     */
    @ApiModelProperty(value="常用药品 1是 0否")
    private String comMedicine;
    

    
    public String getComMedicine() {
		return comMedicine;
	}

	public void setComMedicine(String comMedicine) {
		this.comMedicine = comMedicine;
	}
