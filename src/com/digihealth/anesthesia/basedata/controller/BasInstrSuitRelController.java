...
public class BasInstrSuitRelController extends BaseController
{
     ...
     * @return
     */
    @RequestMapping(value = "/saveInstrSuitRel")
    @ResponseBody
    public String saveInstrSuitRel(@RequestBody BasInstrSuitRel instrSuitRel){
        logger.info("begin saveInstrSuitRel");
        ResponseValue resp = new ResponseValue();
        basInstrSuitRelService.updateInstrSuitRel(instrSuitRel);
        logger.info("end saveInstrSuitRel");
        return resp.getJsonStr();
    }
}
