...
public class BasAnaesMedicineOutRecordController extends BaseController
{
	...
	/**
     * 
     * @discription 批量添加毒麻药取药记录
     * @author pengqing
     * @created 2017年6月13日 下午3:01:40
     * @param basAnaesMedicineInRecord
     * @return
     */
    @RequestMapping(value = "/batAddMedicineOutRecord")
    @ResponseBody
    @ApiOperation(value = "添加毒麻药取药记录", httpMethod = "POST", notes = "添加毒麻药取药记录")
    public String batAddMedicineOutRecord(
        @ApiParam(name = "batAddMedicineOutRecord", value = "毒麻药入库对象") @RequestBody BatAddAnaesMedicineOutRecordFormbean basAnaesMedicineOutRecord)
    {
    	logger.info("begin batAddMedicineOutRecord");
        ResponseValue resp = new ResponseValue();
        if(null == basAnaesMedicineOutRecord)
        {
        	resp.setResultCode("10000001");
        ...
        {
        	try {
        		basAnaesMedicineOutRecordService.batAddAnaesMedicineOutRecord(basAnaesMedicineOutRecord,resp);
			} catch (Exception e) {
				return resp.getJsonStr();
			}
        }
        logger.info("end batAddMedicineOutRecord");
        return resp.getJsonStr();
    }
     ...
     * @return
     */
    @RequestMapping(value = "/batAddMedicineRetreatRecord")
    @ResponseBody
    @ApiOperation(value = "添加毒麻药退药记录", httpMethod = "POST", notes = "添加毒麻药退药记录")
    public String batAddMedicineRetreatRecord(
        @ApiParam(name = "batAddMedicineRetreatRecord", value = "毒麻药退药记录") @RequestBody BatAddAnaesMedicineRetreatFormbean retreatRecord)
    {
    	logger.info("begin batAddMedicineRetreatRecord");
        ResponseValue resp = new ResponseValue();
        ...
        {
        	try {
        		basAnaesMedicineOutRecordService.batAddMedicineRetreatRecord(retreatRecord, resp);
			} catch (Exception e) {
				return resp.getJsonStr();
			}
        }
        logger.info("end batAddMedicineRetreatRecord");
        return resp.getJsonStr();
    }
