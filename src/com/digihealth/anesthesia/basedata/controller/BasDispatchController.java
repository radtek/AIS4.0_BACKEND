...
public class BasDispatchController extends BaseController{
     ...
     * @return
     */
    @RequestMapping(value = "/createEmergencyOperationHNHTYY")
    @ResponseBody
    @ApiOperation(value="创建紧急手术排程",httpMethod="POST",notes="创建紧急手术排程")
    public String createEmergencyOperationHNHTYY(
        @ApiParam(name = "createEmergencyOperationHNHTYY", value = "急诊参数对象") @RequestBody EmgencyOperationFormBean emgencyOperationFormBean)
    {
        logger.info("begin createEmergencyOperationHNHTYY");
        ...
        BasRegOptUtils.IsLocalAnaesSet(regOpt);
        BasRegOptUtils.getOtherInfo(regOpt);
        basDispatchService.createEmergencyOperationHNHTYY(regOpt, dispatch, respValue);
        logger.info("end createEmergencyOperationHNHTYY");
        return respValue.getJsonStr();
    }
    ...
    public String saveDispatch(@ApiParam(name = "dispatchFormBean", value = "排程信息操作对象") @RequestBody DispatchOperationFormBean dispatchFormBean)
    {
