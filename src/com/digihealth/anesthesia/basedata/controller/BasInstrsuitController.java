...
public class BasInstrsuitController extends BaseController
{
        ...
        @ApiParam(name = "instrsuit", value = "手术包对象") @RequestBody BasInstrsuit instrsuit)
    {
        ...
        List<BasInstrument> dressingList = new ArrayList<BasInstrument>();
        List<BasInstrument> allList = new ArrayList<BasInstrument>();
        if (resultInstrsuit != null)
        {
            instrumentList = basInstrumentService.queryInstrumentByInstrsuitId(resultInstrsuit.getInstrsuitId(), "1");
            dressingList = basInstrumentService.queryInstrumentByInstrsuitId(resultInstrsuit.getInstrsuitId(), "2");
            allList = basInstrumentService.queryInstrumentByInstrsuitId(resultInstrsuit.getInstrsuitId(), null);
        }
        resp.put("instrsuit", resultInstrsuit);
        resp.put("resultList", allList);
        resp.put("instrumentList", instrumentList);
        resp.put("dressingList", dressingList);
