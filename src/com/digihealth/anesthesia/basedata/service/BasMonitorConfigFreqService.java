...
public class BasMonitorConfigFreqService extends BaseService {
	...
	public List<BasMonitorConfigFreq> queryMonitorConfigFreqList(SystemSearchFormBean systemSearchFormBean){
	    ...
	    if (StringUtils.isEmpty(systemSearchFormBean.getRoomId()))
        {
            systemSearchFormBean.setRoomId(getCurRoomId(null));
        }
	...
	public BasMonitorConfigFreq searchMonitorFreqByType(String type,String regOptId) {
	    BasMonitorConfigFreq monitorFreq = basMonitorConfigFreqDao.searchMonitorFreqByType(type, getBeid(),getCurRoomId(regOptId));
        return monitorFreq;
    }
