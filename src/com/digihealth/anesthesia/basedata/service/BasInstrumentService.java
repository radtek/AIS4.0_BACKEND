...
public class BasInstrumentService extends BaseService {
	...
	public List<BasInstrument> queryInstrumentByInstrsuitId(String instrsuitId, String type){
		return basInstrumentDao.queryInstrumentByInstrsuitId(instrsuitId, type);
	}
