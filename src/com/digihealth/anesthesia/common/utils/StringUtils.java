...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String zhuanData(String data){
		...
		String str1= s.toString().toLowerCase();
		StringBuffer result = new StringBuffer(str1);
		if(list.size()>0&&list!=null){
			for(int i = 0;i<list.size();i++){
				result.insert(list.get(i)+i, "_");
			}
		}
    ...
    public static String sqlValidate(String str) {
        ...
        String badStr = "'|and |exec |execute |insert |select |select*|delete |update |count |drop |*|%|chr |mid |master |truncate |" +  
                "char |declare |sitename|net user|xp_cmdshell|	;|or |-|+|,|like'|and |exec |execute |insert |create |drop |" +  
                "table |from |grant |use |group_concat|column_name|" +  
                "information_schema.columns|table_schema|union |where |select |select*|delete |update |order |by |count |*|" +  
