...
public interface StatisticsDao extends BaseDao {
    ...
    public List<SearchOperFormBean> searchAnaesQualityControlByType(@Param("qcType") String qcType, @Param("searchFormBean") SearchFormBean searchFormBean);
    
    public List<SearchOperFormBean> searchAnaesPacuQualityControlByType(@Param("qcType") String qcType, @Param("searchFormBean") SearchFormBean searchFormBean);
    
    public List<SearchDeptOperatCountByAsalev>  searchAnaesEffectCountByAnaesMethod(@Param("searchFormBean") SearchFormBean searchFormBean);
