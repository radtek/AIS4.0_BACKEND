...
public class SearchOperFormBean {
	...
	private String venipuncComplicaTime;//中心静脉穿刺并发症发生时间
	
	private String venipuncComplicaDetail;//中心静脉穿刺并发症详情
	
	private String spinalAnaesComplicationTime; //椎管内麻醉后严重神经并发症时间
	
	private String spinalAnaesComplicationDetail; //椎管内麻醉后严重神经并发症

	public String getSpinalAnaesComplicationTime()
    {
        return spinalAnaesComplicationTime;
    }

    public void setSpinalAnaesComplicationTime(String spinalAnaesComplicationTime)
    {
        this.spinalAnaesComplicationTime = spinalAnaesComplicationTime;
    }

    public String getSpinalAnaesComplicationDetail()
    {
        return spinalAnaesComplicationDetail;
    }

    public void setSpinalAnaesComplicationDetail(String spinalAnaesComplicationDetail)
    {
        this.spinalAnaesComplicationDetail = spinalAnaesComplicationDetail;
    }

    public String getVenipuncComplicaTime()
    {
        return venipuncComplicaTime;
    }

    public void setVenipuncComplicaTime(String venipuncComplicaTime)
    {
