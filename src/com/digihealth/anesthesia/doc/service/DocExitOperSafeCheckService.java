...
public class DocExitOperSafeCheckService extends BaseService {
	...
	public DocExitOperSafeCheck searchExitOperCheckByRegOptId(String regOptId) {
		...
		DocExitOperSafeCheck checkPo = docExitOperSafeCheckDao.searchExitOperCheckByRegOptId(regOptId,getBeid());
		if(checkPo!=null){
	 ...
	 */
	@Transactional
	public ResponseValue updateExitOperSafeCheck(DocExitOperSafeCheck exitOperSafeCheck) {
		...
		exitOperSafeCheck.setAnesthetistId(StringUtils.getStringByList(exitOperSafeCheck.getAnesthetistIdList()));
		exitOperSafeCheck.setCircuNurseId(StringUtils.getStringByList(exitOperSafeCheck.getCircunurseIdList()));
		exitOperSafeCheck.setOperatorId(StringUtils.getStringByList(exitOperSafeCheck.getOperatorIdList()));
