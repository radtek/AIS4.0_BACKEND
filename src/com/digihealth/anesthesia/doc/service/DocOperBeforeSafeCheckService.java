...
public class DocOperBeforeSafeCheckService extends BaseService {
	...
	public DocOperBeforeSafeCheck searchOperBeCheckByRegOptId(String regOptId) {
		...
		DocOperBeforeSafeCheck checkPo = docOperBeforeSafeCheckDao.searchOperBeCheckByRegOptId(regOptId);
		if(checkPo!=null){
	...
	public ResponseValue updateOperBeforeSafeCheck(DocOperBeforeSafeCheck operBeforeSafeCheck) {
		...
		operBeforeSafeCheck.setAnesthetistId(StringUtils.getStringByList(operBeforeSafeCheck.getAnesthetistIdList()));
		operBeforeSafeCheck.setCircuNurseId(StringUtils.getStringByList(operBeforeSafeCheck.getCircunurseIdList()));
		operBeforeSafeCheck.setOperatorId(StringUtils.getStringByList(operBeforeSafeCheck.getOperatorIdList()));
