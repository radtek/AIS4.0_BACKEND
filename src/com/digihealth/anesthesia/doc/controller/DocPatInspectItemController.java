...
@Api(value = "DocPatInspectItemController", description = "检验检查明细结果处理类")
public class DocPatInspectItemController extends BaseController {
	...
	public String getPatInspectItemList(@ApiParam(name = "searchFormBean", value = "查询参数") @RequestBody SystemSearchFormBean searchFormBean){
		...
		resp.put("resultList", docPatInspectItemService.getPatInspectItemList(searchFormBean));
