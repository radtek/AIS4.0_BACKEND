...
public class DocAnalgesicPostflup {
    ...
    private Integer calmnessScore;

    /**
     * 运动阻滞评级
     */
	@ApiModelProperty(value = "运动阻滞评级")
    private Integer sportBlockScore;
    ...
    public Integer getCalmnessScore() {
        return calmnessScore;
    }

    public void setCalmnessScore(Integer calmnessScore) {
        this.calmnessScore = calmnessScore;
    }

    public Integer getSportBlockScore() {
        return sportBlockScore;
    }

    public void setSportBlockScore(Integer sportBlockScore) {
