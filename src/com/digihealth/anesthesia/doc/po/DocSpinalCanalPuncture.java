...
public class DocSpinalCanalPuncture {
	...
	public Map<String, Object> getPuncBodyPointMap() {
		return null == puncBodyPointMap ? new HashMap<String, Object>() : puncBodyPointMap;
	}
	...
	public Map<String, Object> getIntubationMap() {
		return null == intubationMap ? new HashMap<String, Object>() : intubationMap;
	}
