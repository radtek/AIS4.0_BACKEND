...
public class DocAnalgesicRecord {
     ...
     */
	@ApiModelProperty(value = "术中镇痛药")
    private String operingAnalgesicMedic;
    ...
    public String getOperingAnalgesicMedic() {
		return operingAnalgesicMedic;
	}

	public void setOperingAnalgesicMedic(String operingAnalgesicMedic) {
		this.operingAnalgesicMedic = operingAnalgesicMedic;
	}
