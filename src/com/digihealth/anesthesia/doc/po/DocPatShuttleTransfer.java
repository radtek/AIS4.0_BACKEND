...
public class DocPatShuttleTransfer {
	 ...
	 * 手术间护士签名
	 */
	@ApiModelProperty(value = "手术间护士签名")
	private String nurseSignUser;

	/**
	 * 手术间护士签名日期时间
	 */
	@ApiModelProperty(value = "手术间护士签名日期时间")
	...
	public void setWorn(String worn) {
		this.worn = worn == null ? null : worn.trim();
	}
	...
	public void setGoodsRemove(String goodsRemove) {
		this.goodsRemove = goodsRemove == null ? null : goodsRemove.trim();
	}
	...
	public void setPreAdviceExec(String preAdviceExec) {
		this.preAdviceExec = preAdviceExec == null ? null : preAdviceExec
				.trim();
	}
