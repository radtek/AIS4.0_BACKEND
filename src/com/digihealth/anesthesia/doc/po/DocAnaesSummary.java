...
public class DocAnaesSummary {
     ...
     * 麻醉医生集合
     */
    @ApiModelProperty(value = "麻醉医生集合")
	List<String> anaesDocList;
    
    /**
     *术后随访记录
     */
	@ApiModelProperty(value = "术后随访记录")
    private String visitRecord;
    
	/**
     * 椎管内穿刺
     */
	@ApiModelProperty(value = "椎管内穿刺")
    ...
    {
        return null == anaesDocList ? new ArrayList<String>() : anaesDocList;
    }
