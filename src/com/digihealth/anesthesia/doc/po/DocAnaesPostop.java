...
public class DocAnaesPostop {
	...
	@ApiModelProperty(value = "麻醉操作部位情况")
    private String anaesPointCase;
	
	@ApiModelProperty(value = "术后镇痛")
    private String postAnalgesia;
	
	@ApiModelProperty(value = "镇痛效果")
	...
	public void setBeforeAnaesPipe(String beforeAnaesPipe) {
		this.beforeAnaesPipe = beforeAnaesPipe;
	}
	...
	public String getAnaesPointCase() {
		return anaesPointCase;
	}

	public void setAnaesPointCase(String anaesPointCase) {
		this.anaesPointCase = anaesPointCase;
	}

	public String getPostAnalgesia() {
		return postAnalgesia;
	}

	public void setPostAnalgesia(String postAnalgesia) {
		this.postAnalgesia = postAnalgesia;
	}

	public String getAnalgesicEffect() {
		return analgesicEffect;
	}

	public void setAnalgesicEffect(String analgesicEffect) {
		this.analgesicEffect = analgesicEffect;
	}
