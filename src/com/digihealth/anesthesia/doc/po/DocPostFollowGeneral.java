...
public class DocPostFollowGeneral {
    ...
    private Integer tracheaCannula;

	
	
    public Integer getTracheaCannula() {
		return tracheaCannula;
	}

	public void setTracheaCannula(Integer tracheaCannula) {
		this.tracheaCannula = tracheaCannula;
	}
