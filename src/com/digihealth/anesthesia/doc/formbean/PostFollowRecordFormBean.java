...
public class PostFollowRecordFormBean implements Serializable {
	...
	@ApiModelProperty(value = "麻醉后访视记录_术后随访情况")
	private DocPostFollowSituation docPostFollowYxrm;
	
	
	
	public DocPostFollowSituation getDocPostFollowYxrm() {
		return docPostFollowYxrm;
	}

	public void setDocPostFollowYxrm(DocPostFollowSituation docPostFollowYxrm) {
