...
public class AnalgesicRecordFormBean implements Serializable{
	...
	private List<DocAnalgesicPostflup> analgesicPostFlup;
	
	public List<DocAnalgesicPostflup> getAnalgesicPostFlup()
    {
        return analgesicPostFlup;
    }
    public void setAnalgesicPostFlup(List<DocAnalgesicPostflup> analgesicPostFlup)
    {
        this.analgesicPostFlup = analgesicPostFlup;
    }
